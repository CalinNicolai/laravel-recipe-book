<nav class="bg-gray-100 border-b border-gray-200">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <button type="button" class="inline-flex items-center justify-center p-2 rounded-md text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 lg:hidden" aria-controls="navbarNav" aria-expanded="false">
            ...
            <div class="hidden lg:flex lg:items-center lg:space-x-4" id="navbarNav">
                ...
                <a href="{{ route('categories.index') }}" class="text-gray-800 hover:text-gray-600 transition">Категории</a>
            </div>
        </div>
        <div class="lg:hidden">
